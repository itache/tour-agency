...
public class SetTourRegularCommand extends AbstractCommand {
    private static final Logger LOG = Logger.getLogger(SetTourRegularCommand.class);

    public SetTourRegularCommand(User.Role... permissions) {
        super(permissions);
    }
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(tourID.isValid()) {
            ...
            service.setRegular(Long.valueOf(tourID.getValue()));
        } else {
